...
<head>
	...
	<title>Mobilix | Your One stop Platform for Airtime and Data | Transfer to Bank</title>
...
<div id="main-content" style="background: #111 !important;display: inline-block !important;padding: 40px 31px !important;color: white;">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M20 10C20 10.3788 19.8683 10.7421 19.6339 11.01C19.3995 11.2778 19.0816 11.4283 18.7501 11.4283H4.26926L9.63616 17.5586C9.75237 17.6914 9.84455 17.8491 9.90744 18.0226C9.97033 18.1961 10.0027 18.3821 10.0027 18.5699C10.0027 18.7577 9.97033 18.9437 9.90744 19.1172C9.84455 19.2907 9.75237 19.4483 9.63616 19.5811C9.51995 19.7139 9.38199 19.8193 9.23016 19.8911C9.07833 19.963 8.9156 20 8.75126 20C8.58692 20 8.42418 19.963 8.27235 19.8911C8.12052 19.8193 7.98256 19.7139 7.86636 19.5811L0.367193 11.0112C0.250798 10.8786 0.158451 10.721 0.095442 10.5474C0.0324329 10.3739 0 10.1879 0 10C0 9.81213 0.0324329 9.6261 0.095442 9.45257C0.158451 9.27905 0.250798 9.12143 0.367193 8.98875L7.86636 0.418872C8.10105 0.150673 8.41935 0 8.75126 0C9.08316 0 9.40147 0.150673 9.63616 0.418872C9.87085 0.687071 10.0027 1.05083 10.0027 1.43012C10.0027 1.80941 9.87085 2.17317 9.63616 2.44136L4.26926 8.57169H18.7501C19.0816 8.57169 19.3995 8.72217 19.6339 8.99003C19.8683 9.25789 20 9.62119 20 10Z" fill="white"/>
            	...
            	<div>
            		...
            		<font class="airt">Transfer to Bank Account</font>
            ...
            <div style="width: 100% !important;display: flex;flex-direction: column;gap: 50px !important;">
            	...
            	<form method="POST" style="width: 100% !important;display: flex;flex-direction: column;gap: 10px !important;" action="banky.php">
            		
                    <div>
                        
                        <div style="width: 100% !important;height: auto;padding: 20px !important;background: #1e1e1e;border-radius: 10px;">
                            
                            <div style="width: 100% !important;display: flex;flex-direction: column;gap: 10px;">

                                <div style="width: 100% !important">
                                    
                                        <select required name="bank" style="background: transparent;border: none;border-bottom: 0.1px solid #6F7075;width: 100% !important;height: 50px;font-family: montserrat;color: white;" class="oh">
                                            
                                            <?php

                                            $seles = "SELECT * FROM `supported_banks`";

                                            $seles_query = mysqli_query($conn, $seles);

                                            if (mysqli_num_rows($seles_query) > 0) {
                                                
                                                while ($ro = mysqli_fetch_assoc($seles_query)){

                                                    $bankCode = $ro["bank_code"];

                                                    $bankName = $ro["bank_name"];


                                            ?>

                                            <option value="<?php echo $bankCode; ?>" style="background: #1e1e1e !important;"><?php echo $bankName; ?></option>
                                ...
                                <div style="display: flex;width: 100% !important;">
                                    ...
                                    <div style="width: 100% !important">
                                        ...
                                        <input type="number" required name="acct" placeholder="Enter 10 Digit Acct No" minlength ="10" maxlength="10" style="background: transparent;border: none;border-bottom: 0.1px solid #6F7075;width: 100% !important;height: 50px;font-family: montserrat;color: white;" class="oh" id="acctNumber" value="<?php echo isset($_POST["acct"]) ? trim($_POST["acct"]) : ''; ?>">
                            ...
                            <div>
                                ...
                                <div>
                                 ...
                                 <div>
                                    ...
                                    <input type="number" name="charge" id="charge" placeholder="Our charges" id="amt" style="background: transparent;border: none;border-bottom: 0.1px solid #6F7075;width: 100% !important;height: 50px;font-family: montserrat;color: white;" class="ohs" required>

                                </div>

                                 <div>
                                    
                                    <input type="number" name="remaining" id="remaining" placeholder="What would be recieved" id="amt" style="background: transparent;border: none;border-bottom: 0.1px solid #6F7075;width: 100% !important;height: 50px;font-family: montserrat;color: white;" class="ohs" required>
...
// Get input elements
        ...
        amtInput.addEventListener('input', function () {
            ...
            if (!isNaN(amt) && amt > 0) {
                const charge = 50; // Calculate 1% charge
                const remaining = (amt - charge).toFixed(2.5);// Remaining amount after charge
